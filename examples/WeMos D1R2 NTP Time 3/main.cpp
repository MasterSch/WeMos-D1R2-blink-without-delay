...
const char ssid[] = "zuhause";  //  your network SSID (name)
const char pass[] = "schmitt.obw@web.de";       // your network password
...
void setupTime() {                              // deinen NTP Server einstellen (von 0 - 5 aus obiger Liste) alternativ lassen sich durch Komma getrennt bis zu 3 Server angeben
  ...
  configTime("CET-1CEST,M3.5.0,M10.5.0/3", ntpServerName[]);  // Zeitzone einstellen https://github.com/nayarsystems/posix_tz_db/blob/master/zones.csv
